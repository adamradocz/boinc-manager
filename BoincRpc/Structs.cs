...
namespace BoincRpc
{
    ...
    public class Result : IEquatable<Result>
    {
        ...
        public bool Abortable
        {
            get
            {
                return ActiveTaskState != TaskState.AbortPending && ActiveTaskState != TaskState.Aborted && State != ResultState.Aborted;
            }
        }
        ...
        public bool GraphicsAvailable
        {
            get
            {
                return !string.IsNullOrEmpty(GraphicsExecPath) && !Suspended && !ProjectSuspended && SchedulerState == SchedulerState.Scheduled;
            }
        }
    ...
    public class CoreClientState
    {
        ...
        public int CoreClientMajorVersion { get; }
        public int CoreClientMinorVersion { get; }
        public int CoreClientReleaseVersion { get; }
        ...
        internal CoreClientState(XElement element)
        {
            ...
            XElement hostInfo = element.Element("host_info");
            if (hostInfo != null)
                HostInfo = new HostInfo(hostInfo);

            CoreClientMajorVersion = element.ElementInt("core_client_major_version");
            CoreClientMinorVersion = element.ElementInt("core_client_minor_version");
            CoreClientReleaseVersion = element.ElementInt("core_client_release");
